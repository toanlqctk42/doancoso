...
namespace TShoes.UI.Modules
{
    partial class ucaccount
    {
        ...
        private void InitializeComponent()
        {
			...
			this.dgvAccout.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.dgvAccout.Location = new System.Drawing.Point(0, 308);
			this.dgvAccout.Name = "dgvAccout";
			this.dgvAccout.Size = new System.Drawing.Size(1104, 331);
			...
			this.btnLuu.Click += new System.EventHandler(this.btnThemAccount_Click);
			// 
			// btnHuy
			// 
			...
			this.Controls.Add(this.btnThemAccount);
